...
<table class="mt-5 mb-5 text-center" style="width: 100%">
	...
	<tr class="hard-line">
		...
		<td colspan="4">${ earlyTime }</td>
	</tr>
	
	<tr class="hard-line">
		<td class="hard-line"><p class="d-flex justify-content-between" style="width: 100px; margin: 0 auto;"><span>유</span><span>형</span></p></td>
		<td colspan="4">
			<c:if test="${ approval.earlyDTO.earlyType eq 9030 }">질병</c:if>
			<c:if test="${ approval.earlyDTO.earlyType eq 9031 }">경조사</c:if>
			<c:if test="${ approval.earlyDTO.earlyType eq 9032 }">외부행사</c:if>
			<c:if test="${ approval.earlyDTO.earlyType eq 9039 }">기타</c:if>
		</td>
	</tr>
	
	<tr class="hard-line">
		<td class="hard-line"><p class="d-flex justify-content-between" style="width: 100px; margin: 0 auto;"><span>사</span><span>유</span></p></td>
		<td colspan="4">${ approval.earlyDTO.earlyReason }</td>
	</tr>
