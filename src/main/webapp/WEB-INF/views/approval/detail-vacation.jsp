...
<table class="mt-5 mb-5 text-center" style="width: 100%">
	...
	<tr class="hard-line">
		...
		<td style="width: 200px;">${ approval.vacationDTO.vacStart }</td>
