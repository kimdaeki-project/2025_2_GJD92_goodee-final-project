...
<!-- 상세보기 모달 -->
<div class="modal fade" id="calendarDetailModal" tabindex="-1" aria-labelledby="viewEventTitle" aria-hidden="true">
  <!-- 가운데 정렬 + 내부 스크롤 -->
    ...
    <div class="modal-content rounded-4">
      ...
      <div class="modal-body pt-0">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="text-secondary" id="detailModalReg"></div>
        </div>
      </div>

      <!-- 푸터 -->
      <div class="modal-footer border-0 justify-content-end">
        <button type="button" class="btn btn-outline-secondary btn-sm d-flex align-items-center btn-update-delete"
        id="btnUpdateCalendar">
          <span class="material-symbols-rounded fs-6">edit</span>
        </button>
        <button type="button" class="btn btn-outline-secondary btn-sm d-flex align-items-center btn-update-delete" 
        id="btnDeleteCalendar">
