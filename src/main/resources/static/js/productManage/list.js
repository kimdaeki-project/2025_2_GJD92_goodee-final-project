function movePage(page) {
	...
	const pmType = document.querySelector("#searchPmType").value;
	...
	let url = `/productManage?page=${page}`;

	    if (pmType) url += `&pmType=${encodeURIComponent(pmType)}`;
